# Correcciones en curso — 2026-08-21

- Schema: las calculadoras no usan `SoftwareApplication` ni `WebApplication`; no se inventan `aggregateRating` ni `review`.
- Recursos internos: referencias CSS/JS normalizadas a rutas absolutas desde la raíz.
- CSS: páginas HTML ahora cargan `styles.min.css`.
