const CACHE='calculadoras-mx-v5.5.5';
const CORE=['/index.html','/calculadoras.html','/simuladores.html','/offline.html','/assets/css/styles.min.css?v=5.5.5','/assets/js/catalog.min.js?v=5.5.5','/assets/js/common.min.js?v=5.5.5','/assets/img/logo.svg','/assets/img/favicon.svg'];
