...
for(const token of ['calculadoras-mx-v5.1.0','/offline.html','/assets/js/catalog.js?v=5.1.0','skipWaiting','clients.claim'])if(!sw.includes(token))errors.push(`Service worker sin ${token}`);
...
for(const file of ['index.html','calculadoras.html','simuladores.html',path.join('calculadoras','isr.html')]){
  ...
  if(!html.includes('assets/js/catalog.js?v=5.1.0'))errors.push(`${file} no carga el catálogo versionado`);
  if(!html.includes('assets/js/common.js?v=5.1.0'))errors.push(`${file} no carga el script común versionado`);
}
